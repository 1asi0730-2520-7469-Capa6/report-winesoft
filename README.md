...
<div align="justify">
  <ul>
    <li>
    <b>What (¿Qué'):</b>
    Las destilerías y plantas de producción de licores enfrentan problemas en el control de sus procesos productivos:<br><br>
    Variaciones en temperatura, humedad y presión que afectan la fermentación, destilación y maduración.<br><br>
    Incumplimiento de normativas sanitarias e industriales por falta de registros confiables.<br><br>
    Pérdidas económicas por fallos en equipos críticos.<br><br>
    Dificultad en la gestión de inventario y trazabilidad de productos.<br><br>

  </li>
  <li>
    <b>When (¿Cuándo?):</b><br>
    Actualmente: el problema existe en el día a día de la producción de licores.<br><br>
    Futuro: la necesidad será aún mayor con la digitalización de la industria y el endurecimiento de regulaciones internacionales.<br><br>
  </li>
  <li>
      <b>Where (¿Dónde?): </b>En plantas de producción de licores y destilerías, principalmente en países donde el sector licorero es relevante (ej. Latinoamérica, Europa y EE.UU.), tanto en instalaciones de gran escala como en productoras medianas que requieren modernizarse.<br><br>
    </li>
    <li>
      <b>Who (¿Quiénes?): </b><br>Usuarios principales: dueños, gerentes de planta e ingenieros de producción de destilerías y fábricas de licores.<br><br>
      Beneficiados indirectos: consumidores (reciben productos de mayor calidad y seguridad), distribuidores y entes reguladores.<br><br>
    </li>
    <li>
      <b>Why (¿Por qué?): </b>Porque la mayoría de destilerías medianas y pequeñas aún utilizan métodos manuales o sistemas no integrados, lo que limita:<br><br>
      El control en tiempo real de los parámetros.<br><br>La capacidad de respuesta ante fallos.<br><br>La eficiencia en auditorías y certificaciones.<br><br>
      Esto impacta directamente en la calidad del producto, los costos de producción y la competitividad en el mercado.<br><br>
    </li>
    <li>
      <b>How (¿Cómo?): </b>A través de un sistema IoT integral que incluye:<br><br>Sensores inteligentes en fermentadores, alambiques y barricas.<br><br>Alertas automáticas por variaciones en parámetros críticos.<br><br>Registro digital de mantenimiento, limpieza y calibración.<br><br>Gestión de inventario y trazabilidad con integración a sistemas ERP.
    </li>
    <li>
      <b>How Much (¿Cuánto?):</b>Costos actuales del problema:<br><br>Pérdidas por lotes defectuosos o contaminación.<br><br>Multas o sanciones por incumplimiento normativo.<br><br>Gastos operativos elevados por controles manuales.<br><br>Inversión estimada:<br><br>Suscripciones mensuales (básico y premium).<br><br>Compra o leasing de sensores y equipos IoT.<br><br>Servicios adicionales de soporte y consultoría.
    </li>
  </ul>
</div>
...
<div align="justify">
  El propósito de nuestro servicio es ofrecer un monitoreo inteligente en tiempo real de los procesos de producción de licores, diseñado en base a la instalación de sensores en las etapas críticas de fermentación, destilación, maduración y almacenamiento. A través de nuestra plataforma, las destilerías tendrán acceso a un panel centralizado con información sobre la temperatura, humedad y presión de sus equipos, además de reportes históricos que facilitan la gestión de calidad y el cumplimiento de normativas.
