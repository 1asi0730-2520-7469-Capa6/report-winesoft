...
| **2.1** | 27/10/2025 | Antonio Rodrigo Duran Diaz | Se realizaron cambios de mejora en algunos puntos de la estructura de carátula.  |
| **2.2** | 13/11/2025 | Joan Teves Samaniego | Se subieron nuevos elementos para el contenido del sprint 3. |
| **2.3** | 14/11/2025 | Antonio Rodrigo Duran Diaz | Modificacion de imagenes y enlaces. |
...
| **3.1** | 26/11/2025 | Antonio Rodrigo Duran Diaz | Se actualizaron imagenes para algunas secciones del documento y elementos que faltaron en el sprint 3. |
| **3.2** | 26/11/2025 | Joan Teves Samaniego | Se agregaron los elementos y contenido para el sprint 4. |
| **3.3** | 01/12/2025 | Antonio Rodrigo Duran Diaz | Actualizacion en documentacion para sprint 4 y subida de nuevos archivos que complementan el contenido faltante en otras secciones del documento.  |
| **3.4** | 01/12/2025 | Joan Teves Samaniego | Se agregaron nuevos archivos, enalces y contenido para el sprint 4. Ademas la actualizacion de elementos en otras secciones del documento. |
| **3.5** | 01/12/2025 | Stephano Moscoso | Se agregaron enlaces de video, nuevas imagenes y actualizacion de elementos del documento.  |
...
En esta entrega final (TF), el equipo completó el ciclo de vida del desarrollo del proyecto **WineSoft**, consolidando la versión *Release* del producto. Durante esta etapa, las actividades principales se centraron en la implementación del **Sprint 4**, que incluyó el desarrollo del Dashboard de métricas, la finalización del flujo de pedidos y la gestión de perfiles de usuario. 

Asimismo, se realizó el despliegue definitivo de todos los componentes (Landing Page, Frontend y Backend) en entornos de producción, asegurando su interoperabilidad. El equipo también llevó a cabo las entrevistas de validación con usuarios reales, la evaluación heurística final y la producción de los materiales audiovisuales obligatorios (*About-the-Product* y *About-the-Team*), garantizando una entrega robusta y funcional.

Con el fin de evidenciar los avances realizados y demostrar la participación activa de todos los miembros del equipo en la elaboración del informe final y el código fuente, se presentan a continuación las capturas obtenidas desde los analíticos de colaboración del repositorio GitHub del proyecto.
...
| --------------------------------| ----------------------| ------------------------------------ |
|![Yazid Said](./imagenes/foto%20yazid.jpg) <br> Said Conde, Yazid   | Ingenieria de Software <br>Universiad Peruana de Ciencias Aplicadas | - Conocimientos en lenguajes de Programación como C++, Java, HTML, CSS, JavaScriptm, Python y C#.<br>Me considero que soy una persona muy trabajadora, responsable, puntual y respetuoso. |
|![Angelo Stephano](./imagenes/foto%20angelo.jpg) <br> Angelo Stephano Moscoso Bejar   | Ingeniería de Software<br> 5to Ciclo<br>2024-1<br>Universidad Peruana de Ciencias Aplicadas | - Tengo 21 años estoy estudiando actualmente en la Univeridad Peruana de Ciencias Aplicadas. Me ha interasado mucho la creación de paginas web para diversos objetivos. Manejo algunos lenguajes de programación como javascript, C++, C+, Python, entre otros. Considero que tengo las habilidades de comunicación efectiva, organización, proactividad, resolución de problemas, entre otras. Espero aportar de manera satisfactoria en mi grupo para terminar de manera exitosa el proyecto. |
|![Gonzalo Alonso](./imagenes/foto%20Gonzalo.jpg) <br> Gonzalo Alonso Carhuancote Dominguez               | Ingenieria de Software <br>Universiad Peruana de Ciencias Aplicadas | - Tengo 20 años, estudio la carrera de ingeniería de software en la UPC. En mis tiempos libres estudio, juego videojuegos y me informo del mundo actual y moderno. Me apasiona la tecnología y manejo lenguajes como C++, Java, Typescript y Python. |
|![Joan Fernando](./imagenes/foto%20joan.jpg) <br> Joan Fernando Teves Samaniego | Ingenieria de Software <br>Universiad Peruana de Ciencias Aplicadas | - Tengo 22 años estoy estudiando actualmente en la Univeridad Peruana de Ciencias Aplicadas. Tengo interes por el mundo de la cibersegurirdad y el primer paso es enteder al derecho y al revez las aplicaciones web , se c++ , javascript , html , css , mongodb ,sql , sqlserver , posgresql,python, soy creativo , responsable , trabajo en equipo , me gusta resolver problemas   me adaptofacilmente y gestiono muy bien mi tiempo.Espero que en este proyecto pueda incrementar mis habilidades y conocimiento sobre las aplicaciones web y demas . |
|![Antonio Rodrigo](./imagenes/foto%20Antonio.jpg) <br> Antonio Rodrigo Duran Díaz      | Ingeniería de Software<br>Universidad Peruana de Ciencias Aplicadas | - Soy estudiante de la carrera de Ingeniería de Software en la Universidad Peruana de Ciencias Aplicadas y tengo 20 años. Estoy avanzando en mi formación académica y reforzando mis conocimientos en los diferentes temas relacionados con la creación de software. Durante mis estudios me ha gustado trabajar con gestores de bases de datos, en especial con SQL Server y MongoDB. En este proyecto espero seguir mejorando mis habilidades y conocimientos, además de lograr un buen desempeño en el trabajo grupal. |
...
| :--- | :--- | :--- | :--- | :--- |
| **EP01** | Landing Page Informativa | Como visitante, quiero acceder a una landing page clara y atractiva, para entender de qué trata WineSoft, conocer sus beneficios y comunicarme si estoy interesado. | — | — |
| **US01** | Landing Page Informativa | Como visitante, quiero una página de inicio clara que explique qué es WineSoft, para entender rápidamente el valor del producto. | **CA1:** Dado que un visitante llega al sitio, cuando carga la página, entonces visualiza un titular claro, descripción del servicio y un llamado a la acción (CTA).<br>**CA2:** Dado que el diseño es atractivo, cuando el visitante navega, entonces los elementos visuales son coherentes y de alta calidad. | EP01 |
| **US02** | Diseño Responsivo | Como visitante, quiero que la landing page se vea bien en cualquier dispositivo (móvil, tablet, escritorio), para tener una buena experiencia de usuario. | **CA1:** Dado que se accede desde un móvil, cuando la página carga, entonces el contenido se reorganiza en una sola columna.<br>**CA2:** Dado que se cambia el tamaño de la ventana del navegador, cuando se ajustan las dimensiones, entonces los elementos se reajustan fluidamente. | EP01 |
| **US03** | Comparador de Planes | Como visitante, quiero comparar los diferentes planes de servicio de WineSoft, para elegir el que mejor se adapte a mis necesidades. | **CA1:** Dado que el visitante va a la sección de precios, cuando la vista carga, entonces se muestra una tabla comparando características y precios.<br>**CA2:** Dado que se selecciona un plan, cuando el usuario hace clic en "Elegir", entonces es redirigido al formulario correspondiente. | EP01 |
| **TS01** | Diseño de Bussiness Web Site | Diseñar la interfaz pública con estructura responsive, secciones informativas y formulario de contacto. | **CA1:** Dado que el visitante ingresa desde cualquier dispositivo, cuando accede al sitio, entonces se adapta correctamente <br>**CA2:** Dado que completa el formulario, cuando envía, entonces el sistema confirma recepción. | EP01 |
| **EP02** | Gestión de Inventario y Almacén Virtual | Como dueño de destilería o licorería, quiero registrar, visualizar y controlar mis insumos en un almacén digital, para mantener actualizado mi inventario y evitar pérdidas por vencimiento o mal control. | — | — |
| **US04** | Registrar nuevo insumo | Como usuario, quiero añadir nuevos insumos con nombre, cantidad, unidad y fecha de vencimiento para mantener mi inventario actualizado. | **CA1:** Dado que el usuario accede al módulo Inventario, cuando completa los datos de un nuevo insumo, entonces el sistema lo guarda correctamente.<br>**CA2:** Dado que el registro es exitoso, cuando se actualiza la lista, entonces el nuevo insumo aparece en la tabla general.<br>**CA3:** Dado que un campo obligatorio está vacío, cuando intenta guardar, entonces el sistema muestra un mensaje de error. | EP02 |
| **US05** | Editar stock existente | Como usuario, quiero actualizar la cantidad o detalles de un insumo para reflejar los cambios en el inventario real. | **CA1:** Dado que existe un insumo registrado, cuando se selecciona “Editar” y se modifican los valores, entonces el sistema guarda los cambios.<br>**CA2:** Dado que el cambio es exitoso, cuando se recarga la vista, entonces la nueva cantidad se refleja.<br>**CA3:** Dado que el usuario intenta editar un insumo inexistente, cuando realiza la acción, entonces el sistema notifica que no se encontró el registro. | EP02 |
...
| **EP07** | Gestión del Perfil de Usuario | **Como** usuario registrado (dueño o proveedor), **quiero** gestionar la información de mi cuenta y mis credenciales, **para** mantener mi perfil actualizado y seguro. | — | — |
| **US24** | Ver mi perfil de usuario | **Como** usuario registrado, **quiero** poder ver la información de mi perfil, **para** confirmar mis datos y acceder a las opciones de edición. | **CA1:** Dado que he iniciado sesión, cuando hago clic en mi nombre o icono de perfil, entonces soy redirigido a la página "Mi Perfil". <br> **CA2:** Dado que estoy en la página "Mi Perfil", cuando la vista carga, entonces puedo ver mi nombre de usuario, correo electrónico y rol (Dueño/Proveedor). | EP07 |
| **US25** | Editar información de contacto | **Como** usuario registrado, **quiero** editar mi información de contacto (como nombre y teléfono), **para** mantener mis datos personales actualizados. | **CA1:** Dado que estoy en la página "Mi Perfil", cuando hago clic en "Editar Perfil", entonces los campos (nombre, teléfono) se vuelven editables. <br> **CA2:** Dado que modifico mi nombre y hago clic en "Guardar", cuando el sistema procesa el cambio, entonces mis datos se actualizan y veo un mensaje de confirmación. <br> **CA3:** Dado que intento guardar un campo obligatorio (como nombre) vacío, cuando hago clic en "Guardar", entonces el sistema muestra un error de validación. | EP07 |
| **US26** | Cambiar mi contraseña | **Como** usuario registrado, **quiero** poder cambiar mi contraseña desde mi perfil, **para** mantener la seguridad de mi cuenta. | **CA1:** Dado que he iniciado sesión y estoy en "Mi Perfil", cuando accedo a la sección "Seguridad" e ingreso mi contraseña actual, la nueva contraseña y la confirmación, entonces el sistema me permite guardar. <br> **CA2:** Dado que ingreso una contraseña actual incorrecta, cuando intento guardar, entonces el sistema muestra un error "Contraseña actual incorrecta". <br> **CA3:** Dado que la nueva contraseña y la confirmación no coinciden, cuando intento guardar, entonces el sistema muestra un error "Las contraseñas no coinciden". | EP07 |
...
| **Sprint Goal & User Stories** | |
| Sprint 3 Goal | Nuestro enfoque está en materializar el núcleo funcional de WineSoft, integrando la interfaz web con los servicios backend desplegados, implementando la seguridad mediante autenticación de usuarios y habilitando la gestión dinámica de inventarios y movimientos de stock a través de una API. Creemos que esto transformará la experiencia de los dueños de destilerías y proveedores, permitiéndoles pasar de registros manuales a una gestión digital eficiente y segura. Esto se confirmará cuando los usuarios puedan iniciar sesión, gestionar sus credenciales, y realizar operaciones completas de registro y actualización de suministros y movimientos en tiempo real a través de la plataforma.|
...
**Enlace:** (https://trello.com/b/6OZyTNeM/sprint-3)
...
| **Sprint Goal & User Stories** | |
| Sprint 4 Goal | Nuestro enfoque en este último Sprint es completar la experiencia de usuario integrando las funcionalidades de valor añadido: gestión de perfil, visualización de métricas de negocio (Dashboard) y trazabilidad de pedidos. Además, aseguraremos la calidad del producto final mediante la validación con usuarios, la producción de material audiovisual y el despliegue definitivo en entornos de producción. Esto se confirmará cuando los usuarios puedan personalizar su cuenta, tomar decisiones basadas en los gráficos del dashboard y el sistema opere de manera estable en la nube.|
| Sprint Velocity | 30 |
