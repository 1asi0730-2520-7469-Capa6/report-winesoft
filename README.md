...
| **Sprint Goal & User Stories** | |
| Sprint 3 Goal | Nos centramos en crear un entorno seguro para el seguimiento del inventario y la realización de pedidos en tiempo real. Creemos que ofrece protección de datos y autonomía logística a los propietarios de destilerías, permitiéndoles digitalizar su cadena de suministro sin depender de registros manuales. Esto se confirmará cuando los usuarios autorizados puedan acceder de forma segura a sus perfiles, visualizar listas de suministro actualizadas y ejecutar correctamente los pedidos de reabastecimiento a través de la plataforma.|
